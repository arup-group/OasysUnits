...
namespace OasysUnits.Wrappers
{
    ...
    public struct ReferencePressure
    {
        ...
        ///     <see cref="OasysUnits.Pressure" />
        ///     parameter. Assumes the <see cref="PressureReference" /> to <see cref="PressureReference.Absolute" />, with 1 atm as
        ///     the atmospheric <see cref="OasysUnits.Pressure" />.
        /// </summary>
        /// <param name="pressure">The measured absolute <see cref="OasysUnits.Pressure" /></param>
        ...
        ///     measured <see cref="OasysUnits.Pressure" /> and <see cref="PressureReference" /> parameters. Assumes 1 atm as the atmospheric
        ///     <see cref="OasysUnits.Pressure" />.
        /// </summary>
        /// <param name="pressure">The measured <see cref="OasysUnits.Pressure" /></param>
        /// <param name="reference">
        ///     The referenced <see cref="PressureReference" /> for the measured <see cref="OasysUnits.Pressure" />
        /// </param>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ReferencePressure" /> struct requiring
        ///     measured <see cref="OasysUnits.Pressure" />, <see cref="PressureReference" />, and atmospheric <see cref="OasysUnits.Pressure" />
        ///     parameters
        /// </summary>
        /// <param name="pressure">The measured <see cref="OasysUnits.Pressure" /></param>
        /// <param name="reference">
        ///     The referenced <see cref="PressureReference" /> for the measured <see cref="OasysUnits.Pressure" />
        /// </param>
        /// <param name="atmosphericPressure">The atmospheric <see cref="OasysUnits.Pressure" /> where the measurement was taken.</param>
        ...
        /// <summary>
        ///     Converts <see cref="ReferencePressure" /> to <see cref="OasysUnits.Pressure" /> at <see cref="PressureReference" />
        /// </summary>
        /// <param name="reference">The <see cref="PressureReference" /> to convert <see cref="ReferencePressure" /> to.</param>
        /// <returns>The <see cref="OasysUnits.Pressure" /> at the specified <see cref="PressureReference" /></returns>
        ...
        /// <summary>
        ///     Converts <see cref="OasysUnits.Pressure.Value" /> to <see cref="double" /> at <see cref="PressureReference" />
        /// </summary>
        /// <param name="reference">The <see cref="PressureReference" /> to convert <see cref="ReferencePressure" /> to.</param>
        ...
        /// <summary>
        ///     Converts <see cref="OasysUnits.Pressure.Value" /> at <see cref="Reference" /> to <see cref="double" /> at
