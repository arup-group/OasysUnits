...
dotnet run --project "%projectdir%/OasysUnits.Benchmark" -c Release ^
--framework net8.0 ^
...
:: dotnet run --project "%scriptdir%/OasysUnits.Benchmark" -c Release -f net8.0 --runtimes net48 net8.0 --filter ** --artifacts="%scriptdir%/Artifacts/Benchmark" --exporters json
