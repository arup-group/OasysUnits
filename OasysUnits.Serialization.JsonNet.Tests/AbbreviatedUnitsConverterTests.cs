...
using OasysUnits.Tests.Serialization;
...
namespace OasysUnits.Serialization.JsonNet.Tests
{
    public class AbbreviatedUnitsConverterTests : JsonNetSerializationTestsBase
    {
        ...
        [Fact]
        public void OasysUnitsExceptionThrown_WhenDeserializing_FromUnknownQuantityType()
        {
            var json = """{"Value":1.2,"Unit":"mg","Type":"invalid"}""";

            Assert.Throws<OasysUnitsException>(() => DeserializeObject<Mass>(json));
        }
