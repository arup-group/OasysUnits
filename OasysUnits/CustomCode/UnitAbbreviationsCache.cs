...
namespace OasysUnits
{
    ...
    public sealed class UnitAbbreviationsCache
    {
        ...
        /// </summary>
        [Obsolete("Use OasysUnitsSetup.Default.UnitAbbreviations instead.")]
        public static UnitAbbreviationsCache Default => OasysUnitsSetup.Default.UnitAbbreviations;
        ...
        /// This is used to dynamically add abbreviations for existing unit enums such as <see cref="OasysUnits.Units.LengthUnit"/> or to extend with third-party unit enums
        ...
        private IReadOnlyList<string> ReadAbbreviationsFromResourceFile(string? quantityName, string unitPluralName, CultureInfo culture)
        {
            ...
            string resourceName = $"OasysUnits.GeneratedCode.Resources.{quantityName}";
        ...
        /// </remarks>
        /// <param name="UnitTypeName">The unit enum type name, such as "OasysUnits.Units.LengthUnit" or "MyApp.HowMuchUnit".</param>
        ...
        {
            /// <summary>
            ///     The unit enum type name, such as "OasysUnits.Units.LengthUnit" or "MyApp.HowMuchUnit".
            /// </summary>
