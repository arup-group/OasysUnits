...
namespace OasysUnits
{
    public partial struct PressureChangeRate
    {
        ...
        {
            return new Pressure(pressureChangeRate.PascalsPerSecond * timeSpan.TotalSeconds , OasysUnits.Units.PressureUnit.Pascal);
        }
        ...
        {
            return new Pressure(pressureChangeRate.PascalsPerSecond * duration.Seconds, OasysUnits.Units.PressureUnit.Pascal);
        }
    }
}
