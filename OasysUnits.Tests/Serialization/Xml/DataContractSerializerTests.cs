...
namespace OasysUnits.Tests.Serialization.Xml
{
    /// <summary>
    ...
    public class DataContractSerializerTests : SerializationTestsBase<string>
    {
        ...
        private const string Namespace = "xmlns=\"http://schemas.datacontract.org/2004/07/OasysUnits\"";
        ...
        public void InterfaceObject_IncludesTypeInformation()
        {
            ...
            var quantityNamespace = "xmlns:a=\"http://schemas.datacontract.org/2004/07/OasysUnits\""; // there is an extra 'a' compared to Namespace
            ...
            var expectedXml = $"<TestInterfaceObject xmlns=\"http://schemas.datacontract.org/2004/07/OasysUnits.Tests.Serialization\" {XmlSchema}>{expectedQuantityXml}</TestInterfaceObject>";
