...
internal readonly struct QuantityDisplay(IQuantity quantity)
{
    ...
    internal readonly struct AbbreviationDisplay
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        public string DefaultAbbreviation => OasysUnitsSetup.Default.UnitAbbreviations.GetDefaultAbbreviation(_quantity.Unit);

        [DebuggerBrowsable(DebuggerBrowsableState.RootHidden)]
        public string[] Abbreviations =>
            OasysUnitsSetup.Default.UnitAbbreviations.GetUnitAbbreviations(_quantity.QuantityInfo.UnitType, Convert.ToInt32(_quantity.Unit));
        ...
        internal readonly struct ConvertedQuantity(IQuantity baseQuantity, Enum unit)
        {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            public string Abbreviation => OasysUnitsSetup.Default.UnitAbbreviations.GetDefaultAbbreviation(Unit);
    ...
    internal readonly struct QuantityConvertor
    {
        ...
        internal readonly struct ConvertedQuantity(IQuantity quantity)
        {
            ...
            public string Abbreviation => OasysUnitsSetup.Default.UnitAbbreviations.GetDefaultAbbreviation(Quantity.Unit);
            public ValueDisplay Value => new(Quantity);
