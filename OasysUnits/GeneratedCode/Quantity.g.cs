    ...
    public partial class Quantity
    {
        ...
        public static bool TryFrom(QuantityValue value, Enum? unit, [NotNullWhen(true)] out IQuantity? quantity)
        {
            quantity = unit switch
            {
                ...
                AxialStiffnessUnit axialStiffnessUnit => AxialStiffness.From(value, axialStiffnessUnit),
                BendingStiffnessUnit bendingStiffnessUnit => BendingStiffness.From(value, bendingStiffnessUnit),
                ...
                CurvatureUnit curvatureUnit => Curvature.From(value, curvatureUnit),
                ...
                LapseRateUnit lapseRateUnit => LapseRate.From(value, lapseRateUnit),
                ...
                MomentUnit momentUnit => Moment.From(value, momentUnit),
                MomentPerLengthUnit momentPerLengthUnit => MomentPerLength.From(value, momentPerLengthUnit),
                ...
                SectionModulusUnit sectionModulusUnit => SectionModulus.From(value, sectionModulusUnit),
                ...
                StrainUnit strainUnit => Strain.From(value, strainUnit),
