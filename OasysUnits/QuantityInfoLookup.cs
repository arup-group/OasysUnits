...
namespace OasysUnits
{
    ...
    internal class QuantityInfoLookup
    {
        ...
        /// <inheritdoc cref="Quantity.TryFrom(QuantityValue,System.Enum,out OasysUnits.IQuantity)"/>
        ...
        public IQuantity Parse(IFormatProvider? formatProvider, Type quantityType, string quantityString)
        {
            if (!typeof(IQuantity).IsAssignableFrom(quantityType))
                throw new ArgumentException($"Type {quantityType} must be of type OasysUnits.IQuantity.");
        ...
        /// <inheritdoc cref="Quantity.TryParse(IFormatProvider,System.Type,string,out OasysUnits.IQuantity)"/>
