...
namespace OasysUnits
{
    ...
    {
        /// <summary>
        /// The unit to convert to, such as <see cref="OasysUnits.Units.LengthUnit" />. Defaults to the unit the quantity as constructed with.
        /// </summary>
