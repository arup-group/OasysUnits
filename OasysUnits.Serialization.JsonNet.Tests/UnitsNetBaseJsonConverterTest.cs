...
namespace OasysUnits.Serialization.JsonNet.Tests
{
    public sealed class OasysUnitsBaseJsonConverterTest
    {
        private readonly TestConverter _sut;

        public OasysUnitsBaseJsonConverterTest()
        {
            _sut = new TestConverter();
        }

        [Fact]
        public void OasysUnitsBaseJsonConverter_ConvertIQuantity_works_with_double_type()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ConvertIQuantity_throws_ArgumentNullException_when_quantity_is_NULL()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ConvertValueUnit_works_as_expected()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ConvertValueUnit_throws_OasysUnitsException_when_unit_does_not_exist()
        {
            var result = Assert.Throws<OasysUnitsException>(() => _sut.Test_ConvertDoubleValueUnit("SomeImaginaryUnit.Watt", 10.2365D));

            Assert.Equal("Unable to find enum type.", result.Message);
            Assert.True(result.Data.Contains("type"));
            Assert.Equal("OasysUnits.Units.SomeImaginaryUnit,OasysUnits", result.Data["type"]);
        }

        [Fact]
        public void OasysUnitsBaseJsonConverter_ConvertValueUnit_throws_OasysUnitsException_when_unit_is_in_unexpected_format()
        {
            var result = Assert.Throws<OasysUnitsException>(() => _sut.Test_ConvertDoubleValueUnit("PowerUnit Watt", 10.2365));
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_CreateLocalSerializer_works_as_expected()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ReadValueUnit_works_with_double_quantity()
        {
        ...
        ///     <br/><br/>
        ///     <see cref="double"/> based quantities were serialized with <see cref="OasysUnitsBaseJsonConverter{T}.ValueUnit"/> DTO, with <c>double Value</c> + <c>string Unit</c> properties.<br />
        ///     <see cref="decimal"/> based quantities were serialized with <see cref="OasysUnitsBaseJsonConverter{T}.ExtendedValueUnit"/> DTO, extending with ValueString and ValueType properties.
        /// </summary>
        [Fact]
        public void OasysUnitsBaseJsonConverter_ReadValueUnit_works_with_legacy_decimal_quantity()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ReadValueUnit_returns_null_when_value_is_a_string()
        {
        ...
        [Fact]
        public void OasysUnitsBaseJsonConverter_ReadDoubleValueUnit_works_with_empty_token()
        {
        ...
        public void OasysUnitsBaseJsonConverter_ReadValueUnit_returns_null_when_unit_or_value_is_missing(bool withUnit, bool withValue)
        {
            var token = new JObject();
        ...
        [InlineData("unit", "value")]
        [InlineData("unIT", "vAlUe")]
        public void OasysUnitsBaseJsonConverter_ReadValueUnit_works_case_insensitive(
        ...
        /// <summary>
        /// Dummy converter, used to access protected methods on abstract OasysUnitsBaseJsonConverter{T}
        /// </summary>
        private class TestConverter : OasysUnitsBaseJsonConverter<string>
        {
