...
namespace OasysUnits
{
    public partial struct Area
    {
        ...
        {
            if (SquareMeters == 0.0)
                return new ReciprocalArea(0.0, OasysUnits.Units.ReciprocalAreaUnit.InverseSquareMeter);

            return new ReciprocalArea(1 / SquareMeters, OasysUnits.Units.ReciprocalAreaUnit.InverseSquareMeter);
        }
