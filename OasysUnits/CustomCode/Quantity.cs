...
namespace OasysUnits
{
    ...
    {
        private static QuantityInfoLookup Default => OasysUnitsSetup.Default.QuantityInfoLookup;
        ...
        public static IQuantity From(QuantityValue value, Enum unit)
        {
            return TryFrom(value, unit, out IQuantity? quantity)
                ? quantity
                : throw new UnitNotFoundException($"Unit value {unit} of type {unit.GetType()} is not a known unit enum type. Expected types like OasysUnits.Units.LengthUnit. Did you pass in a custom enum type defined outside the OasysUnits library?");
        }
        ...
        ///     Prefer <see cref="From(OasysUnits.QuantityValue,System.Enum)"/> or <see cref="From(OasysUnits.QuantityValue,string,string)"/> instead.
        /// </remarks>
        /// <param name="value">Numeric value.</param>
        ...
        public static IQuantity FromUnitAbbreviation(IFormatProvider? formatProvider, QuantityValue value, string unitAbbreviation)
        {
            ...
            if (units.Count == 0)
            {
                throw new UnitNotFoundException($"Unit abbreviation {unitAbbreviation} is not known. Did you pass in a custom unit abbreviation defined outside the OasysUnits library? This is currently not supported.");
            }
        ...
        /// <inheritdoc cref="TryFrom(QuantityValue,System.Enum,out OasysUnits.IQuantity)"/>
        ...
        /// <exception cref="ArgumentException">Type must be of type OasysUnits.IQuantity -or- Type is not a known quantity type.</exception>
        /// <exception cref="UnitNotFoundException">Type must be of type OasysUnits.IQuantity -or- Type is not a known quantity type.</exception>
        ...
        /// <inheritdoc cref="TryParse(IFormatProvider,System.Type,string,out OasysUnits.IQuantity)"/>
