...
namespace OasysUnits.Serialization.JsonNet.Tests
{
    public sealed class OasysUnitsIComparableJsonConverterTest
    {
        ...
        {
            _sut = new OasysUnitsIComparableJsonConverter();
        }

        [Fact]
        public void OasysUnitsIComparableJsonConverter_CanWrite_returns_false()
        {
        ...
        [Fact]
        public void OasysUnitsIComparableJsonConverter_CanRead_returns_true()
        {
        ...
        public void OasysUnitsIComparableJsonConverter_ReadJson_throws_ArgumentNullException_when_arguments_are_null(JsonReader reader, JsonSerializer serializer, string paramName)
        {
        ...
        [Fact]
        public void OasysUnitsIComparableJsonConverter_ReadJson_handles_NULL_values_correctly()
        {
            var json = "null";
        ...
        [Fact]
        public void OasysUnitsIComparableJsonConverter_ReadJson_deserializes_as_concrete_type_when_objectType_not_IComparable()
        {
        ...
        [Fact]
        public void OasysUnitsIComparableJsonConverter_ReadJson_falls_back_to_default_IComparable_deserialization_when_unable_to_deserialize_as_ValueUnit()
        {
            string json = "{ \"$type\": \"OasysUnits.Serialization.JsonNet.Tests.Infrastructure.TestObjectWithValueAsIComparable, OasysUnits.Serialization.JsonNet.Tests\", \"value\": 120 }";
            IComparable result;
        ...
        [Fact]
        public void OasysUnitsIComparableJsonConverter_ReadJson_works_as_expected()
        {
