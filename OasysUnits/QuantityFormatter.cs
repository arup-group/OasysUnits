...
namespace OasysUnits
{
    ...
    {
        /// <summary>
        /// The available OasysUnits custom format specifiers.
        /// </summary>
        private static readonly char[] OasysUnitsFormatSpecifiers = { 'A', 'a', 'G', 'g', 'Q', 'q', 'S', 's', 'U', 'u', 'V', 'v' };
            ...
            where TUnitType : Enum
        {
            ...
            if (OasysUnitsFormatSpecifiers.Any(OasysUnitsFormatSpecifier => OasysUnitsFormatSpecifier == formatSpecifier))
            {
                // OasysUnits custom format string
