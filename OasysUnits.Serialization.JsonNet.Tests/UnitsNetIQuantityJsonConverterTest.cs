...
{
    public sealed class OasysUnitsIQuantityJsonConverterTest
    {
        private readonly OasysUnitsIQuantityJsonConverter _sut;

        public OasysUnitsIQuantityJsonConverterTest()
        {
            _sut = new OasysUnitsIQuantityJsonConverter();
        }

        [Fact]
        public void OasysUnitsIQuantityJsonConverter_CanWrite_returns_true()
        {
        ...
        public void
            OasysUnitsIQuantityJsonConverter_WriteJson_throws_ArgumentNullException_when_arguments_are_null(JsonWriter writer, JsonSerializer serializer, string parameterName)
        {
        ...
        [Fact]
        public void OasysUnitsIQuantityJsonConverter_WriteJson_works_with_NULL_value()
        {
        ...
        [Fact]
        public void OasysUnitsIQuantityJsonConverter_WriteJson_works_with_double_quantity()
        {
            var result = new StringBuilder();
        ...
        [Fact]
        public void OasysUnitsIQuantityJsonConverter_CanRead_returns_true()
        {
        ...
        public void OasysUnitsIQuantityJsonConverter_ReadJson_throws_ArgumentNullException_when_arguments_are_null(JsonReader reader, JsonSerializer serializer, string paramName)
        {
        ...
        [Fact]
        public void OasysUnitsIQuantityJsonConverter_ReadJson_handles_NULL_values_correctly()
        {
            var json = "null";
        ...
        [Fact]
        public void OasysUnitsIQuantityJsonConverter_ReadJson_works_as_expected()
        {
