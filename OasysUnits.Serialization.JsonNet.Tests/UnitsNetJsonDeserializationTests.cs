...
{
    public sealed class OasysUnitsJsonDeserializationTests : OasysUnitsJsonBaseTest
    {
        [Fact]
        ...
        /// <summary>
        ///     Testing deserialization of JSON, based on <see cref="OasysUnitsBaseJsonConverter{T}.ValueUnit"/>.
        /// </summary>
        [Fact]
