...
namespace OasysUnits
{
        ...
        IFormattable
    {
        ...
        public static ReactiveEnergy AdditiveIdentity => Zero;
        ...
        /// <inheritdoc cref="TryParseUnit(string,IFormatProvider,out OasysUnits.Units.ReactiveEnergyUnit)"/>
        ...
        /// <summary>Compares the current <see cref="ReactiveEnergy"/> with another <see cref="ReactiveEnergy"/> and returns an integer that indicates whether the current instance precedes, follows, or occurs in the same position in the sort order as the other when converted to the same unit.</summary>
        ...
        {
            return other is ReactiveEnergy otherTyped
                   && (tolerance is ReactiveEnergy toleranceTyped
                       ? true
                       : throw new ArgumentException($"Tolerance quantity ({tolerance.QuantityInfo.Name}) did not match the other quantities of type 'ReactiveEnergy'.", nameof(tolerance)))
