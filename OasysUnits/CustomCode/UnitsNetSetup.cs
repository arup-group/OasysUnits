...
/// <summary>
///     OasysUnits setup of quantities, units, unit abbreviations and conversion functions.<br />
///     <br />
...
///     <see cref="QuantityFormatter.Format{TUnitType}(OasysUnits.IQuantity{TUnitType},string)" />.
/// </summary>
public sealed class OasysUnitsSetup
{
    static OasysUnitsSetup()
    {
        var unitConverter = UnitConverter.CreateDefault();
        ICollection<QuantityInfo> quantityInfos = Quantity.ByName.Values;

        Default = new OasysUnitsSetup(quantityInfos, unitConverter);
    }

    /// <summary>
    ///     Create a new OasysUnits setup with the given quantities, their units and unit conversion functions between units.
    /// </summary>
    ...
    public OasysUnitsSetup(ICollection<QuantityInfo> quantityInfos, UnitConverter unitConverter)
    {
    ...
    /// <summary>
    ///     The global default OasysUnits setup of quantities, units, unit abbreviations and conversion functions.
